...
{
    BoltRW& robot = *static_cast<BoltRW*>(args);
    ...
    Eigen::Vector7d desired_joint_position = Eigen::Vector7d::Zero();
    Eigen::Vector7d desired_torque = Eigen::Vector7d::Zero();

    Eigen::Vector7d init_pose;
    Eigen::Matrix<bool, 7, 1> motor_enabled;

    robot.acquire_sensors();
    Eigen::Vector7d initial_joint_positions = robot.get_joint_positions();
    ...
    while (!CTRL_C_DETECTED)
    {
        ...
        desired_joint_position =
            ...
            Eigen::Vector7d::Ones() * amplitude * sin(2 * M_PI * freq * t);
        t += dt;
