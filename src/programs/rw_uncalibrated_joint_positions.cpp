 ...
 */
// goes to the executable path ./install/bolt/lib/bolt/rw_bolt_joint_offsets
...
{
    BoltRW& robot = *(static_cast<BoltRW*>(robot_void_ptr));

    //joints = robot.get_joint_positions()

    Eigen::Vector7d joint_index_to_zero = Eigen::Vector7d::Zero();
    Eigen::Vector7d dummy_command = Eigen::Vector7d::Zero();
