...
class DgBoltRWBaseRobot(Robot):
    ...
    def __init__(
        ...
        # Load the robot
        self._simulated_robot = BoltRWRobot(
            robotStartPos,
        ...
        super(DgBoltRWBaseRobot, self).__init__(
